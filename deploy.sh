...
sudo docker create --name cyk-tika -m 2G --restart always -v /home/tika/org.cyk.docker.devkoms.tika:/config -v /home/kwordz/files:/home/kwordz/files cyk/logicalspark/tika:2.3.0 -c ./config/config.xml

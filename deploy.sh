...
sudo docker create --name cyk-tika -m 2G --restart always -v /home:/config -v /home/kwordz/files:/home/kwordz/files cyk/logicalspark/tika:2.3.0 -c ./tika-config.xml
